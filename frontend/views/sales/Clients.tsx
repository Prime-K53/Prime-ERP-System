                      ...
                      <td className="table-body-cell">
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <div className="relative">
                            ...
                            {activeMenuId === customer.id && menuAnchor && (
                              <div
                                onClick={(e) => e.stopPropagation()}
                                className="fixed bg-white rounded-lg shadow-2xl border border-slate-200 py-1.5 z-[100] animate-in fade-in zoom-in-95"
                                style={{
                                    top: Math.min(menuAnchor.y, window.innerHeight - 200),
                                    left: Math.min(menuAnchor.x - 176, window.innerWidth - 186),
                                    width: '176px'
                                }}
                              >
                                <div className="px-3 py-1.5 border-b border-slate-100 text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1">Actions</div>
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    setActiveMenuId(null);
                                  ...
                                  className="w-full text-left px-3 py-2 text-[12.5px] font-semibold text-slate-700 hover:bg-blue-50 flex items-center gap-2 transition-colors"
                                >
                                ...
                                <button
                                  ...
                                  className="w-full text-left px-3 py-2 text-[12.5px] font-semibold text-rose-600 hover:bg-rose-50 flex items-center gap-2 transition-colors"
                                >
                                  <Trash2 size={14} />
                                  Delete Client
                                </button>
