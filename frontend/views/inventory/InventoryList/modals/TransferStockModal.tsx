...
import { X, ArrowRight, Warehouse, AlertCircle, Loader2 } from 'lucide-react';
      ...
      <div className="bg-white rounded-[16px] w-full max-w-md overflow-hidden" style={{ boxShadow: '0 1px 2px rgba(15,30,25,.04), 0 6px 18px rgba(15,30,25,.05)' }}>
        <div className="px-5 py-4 border-b border-[#E5E8E1] flex items-center justify-between bg-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-bold" style={{ color: '#16201B' }}>Transfer Stock</h2>
        ...
        <div className="p-5 space-y-4">
          <div className="flex items-center justify-between px-4 py-3 rounded-[10px] border border-[#EFF1EB]" style={{ background: '#F6F7F2' }}>
          ...
          {sameWarehouse && <p className="text-xs flex items-center gap-1 font-medium" style={{ color: '#B9791C' }}><AlertCircle size={12} /> Source and destination must differ</p>}
