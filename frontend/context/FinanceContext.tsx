        ...
        if (!isPosInvoice) {
            ...
            if (customer?.phone) {
                const isExaminationInvoice =
                    String(finalizedInvoice.originModule || finalizedInvoice.origin_module || '').toLowerCase() === 'examination'
                    || String(finalizedInvoice.documentTitle || '').toLowerCase().includes('examination invoice')
